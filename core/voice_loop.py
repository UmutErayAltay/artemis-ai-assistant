...
class VoiceAssistant:
    ...
    def _listen_for_confirmation(self) -> str:
        ...
        try:
            ...
            # `.lower()` BİLEREK yapılmaz: `is_clear_affirmative_answer` zaten
            # `turkish_lower()` uyguluyor (bkz. `utils.text._NEGATIVE_WORDS` docstring'i
            ...
            # ve `utils.text._NEGATIVE_WORDS`'teki "iptal" ile eşleşmiyordu. Bugün
            ...
            return self._ensure_stt().transcribe(audio, hotwords=", ".join(sorted(AFFIRMATIVE_WORDS)))
        except Exception:
